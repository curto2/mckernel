...
#ifndef LINEAR_FREEZE_HPP
#define LINEAR_FREEZE_HPP
...
namespace lg
{
	class Linear_Freeze : public Operation
	{
		public:
			Linear_Freeze();
			Linear_Freeze(const int size, bool use_bias = true, const float gradient_clipping = 0, float l1_regularization = 0, float l2_regularization = 0);
			Linear_Freeze(lg::IOData& data);
...
#endif /* end of include guard: LINEAR_FREEZE_HPP */
